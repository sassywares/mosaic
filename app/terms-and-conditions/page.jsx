...
export const metadata = {
  title: "Terms and Conditions — Mosaic digital",
        ...
        <div className="page" id="top">
          ...
          <main id="main" className="page-section">
            <div className="container position-relative">
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Mosaic Digital
                    LLC, 123 Main St, Arkansas, USA.
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Mosaic, accessible from{" "}
                    <a
                      href="https://mosaic-digital.pages.dev"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://mosaic-digital.pages.dev
                    </a>
                  </p>
                </li>
                <li>
              ...
              <ul>
                <li>By email: hello@mosaic-digital.pages.dev</li>
              </ul>
            </div>
          </main>
